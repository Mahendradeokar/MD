export function About() {
  return (
    <section aria-labelledby="about-heading" className="w-full">
      ...
      <p className="m-0 max-w-[68ch] text-[clamp(0.9375rem,2.5vw,1.0625rem)] leading-relaxed text-muted-foreground sm:text-[clamp(1rem,2.5vw,1.0625rem)]">
        Frontend-focused Software Engineer with 3+ years building
